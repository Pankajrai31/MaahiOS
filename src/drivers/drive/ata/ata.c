...
void ata_init(void) {
    ...
    if (g_ata_drives[0].type != ATA_DEVICE_TYPE_UNKNOWN) {
        ...
        KLOG_INFO("ATA", "Primary Master: %s", 
                  g_ata_drives[0].type == ATA_DEVICE_TYPE_ATAPI ? "ATAPI" : "ATA");
    }
    ...
    if (g_ata_drives[1].type != ATA_DEVICE_TYPE_UNKNOWN) {
        ...
        KLOG_INFO("ATA", "Primary Slave: %s",
                  g_ata_drives[1].type == ATA_DEVICE_TYPE_ATAPI ? "ATAPI" : "ATA");
    }
    ...
    if (g_ata_drives[2].type != ATA_DEVICE_TYPE_UNKNOWN) {
        ...
        KLOG_INFO("ATA", "Secondary Master: %s",
                  g_ata_drives[2].type == ATA_DEVICE_TYPE_ATAPI ? "ATAPI" : "ATA");
    }
    ...
    if (g_ata_drives[3].type != ATA_DEVICE_TYPE_UNKNOWN) {
        ...
        KLOG_INFO("ATA", "Secondary Slave: %s",
                  g_ata_drives[3].type == ATA_DEVICE_TYPE_ATAPI ? "ATAPI" : "ATA");
    }
